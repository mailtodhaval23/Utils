...
public class Record3 implements AbstractVariableSet<Object>,Serializable{
//public class Record implements AbstractVariableSet<Object>{
	
	transient LinkedTreeMap<String, Object> record;
	/**
	 * 
	 */
